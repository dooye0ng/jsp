...
<form action="modifyResult.jsp" method = "post">
	<table border="1">
			...
			<tr>
				<th> ID </th>
				<th> <%=userId%></th>
				<input type="hidden" name="mod_id" value = "<%=userId%>">
			</tr>
			<tr>
				<th> E-MAIL </th>
				<td> <input type="email" name="mod_email"  value ="<%=userEmail%>" required> </td>
			</tr>
			<tr>
				<th> NAME </th>
				<td> <input type="text" name="mod_name" value ="<%=userName%>" required> </td>
			</tr>
			<tr>
				<th> PW </th>
